...
/**
* Summary. Obtener la conexión a la base de datos. Este es el método que efectivamente abre la conexión con MySQL. Establece la propiedad ->link y la asigna a la variable global $db_link.
*/
	...
	public function getFieldsProperties($res = null, $tipos = true) {
		...
		for ($i=0; $i < $cantidadCampos; $i++) { 
			...
			if(is_array($tipos)){
				...
				$this->tipoCampos[$field->name] = $field;
			}
		}
