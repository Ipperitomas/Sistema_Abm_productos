...
?>
		<tr >
			...
			<td><button class="btn btn-xs bg-gradient-primary" title="Editar categoria..." onClick="ventana_editarcategorias.Show({id:<?php echo $fila['id']; ?>});"><i class="far fa-edit"></i> Editar</button></td>
			<td><button class="btn btn-xs bg-gradient-danger" title="Eliminar categoria..." onClick="Eliminar(<?php echo $fila['id']; ?>);"><i class="fas fa-times"></i> Eliminar </button></td>
		</tr>
<?php
		}
?>
